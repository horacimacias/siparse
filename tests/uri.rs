extern crate siparse;

use siparse::{Error, Request, Status, EMPTY_HEADER};
...
req! {
    urltest_001,
    b"GET /bar;par?b SIP/2.0\r\nHost: foo\r\n\r\n",
    |req| {
        assert_eq!(req.method.unwrap(), "GET");
        assert_eq!(req.path.unwrap(), "/bar;par?b");
        assert_eq!(req.version.unwrap(), 2);
...
req! {
    urltest_103,
    b"GET /foo%2%C3%82%C2%A9zbar SIP/2.0\r\nHost: example.com\r\n\r\n",
    |req| {
        assert_eq!(req.method.unwrap(), "GET");
...
req! {
    urltest_111,
    b"GET /%7Ffp3%3Eju%3Dduvgw%3Dd SIP/2.0\r\nHost: example.com\r\n\r\n",
    |req| {
        assert_eq!(req.method.unwrap(), "GET");
...
req! {
    urltest_113,
    b"GET /%E4%BD%A0%E5%A5%BD%E4%BD%A0%E5%A5%BD SIP/2.0\r\nHost: example.com\r\n\r\n",
    |req| {
        assert_eq!(req.method.unwrap(), "GET");
...
req! {
    urltest_116,
    b"GET /%E2%80%AE/foo/%E2%80%AD/bar SIP/2.0\r\nHost: example.com\r\n\r\n",
    |req| {
        assert_eq!(req.method.unwrap(), "GET");
...
req! {
    urltest_140,
    b"GET /%E4%B8%AD/test.txt SIP/2.0\r\nHost: www.example.com\r\n\r\n",
    |req| {
        assert_eq!(req.method.unwrap(), "GET");
...
req! {
    urltest_143,
    b"GET /%EF%BF%BD?%EF%BF%BD SIP/2.0\r\nHost: x\r\n\r\n",
    |req| {
        assert_eq!(req.method.unwrap(), "GET");
...
req! {
    urltest_178,
    b"GET /relative_import.html SIP/2.0\r\nHost: 127.0.0.1\r\n\r\n",
    |req| {
        assert_eq!(req.method.unwrap(), "GET");
...
req! {
    urltest_192,
    b"GET /C:/Users/Domenic/Dropbox/GitHub/tmpvar/jsdom/test/level2/html/files/pix/submit.gif SIP/2.0\r\nHost: \r\n\r\n",
    |req| {
        assert_eq!(req.method.unwrap(), "GET");
...
req! {
    urltest_235,
    b"GET /someconfig;mode=netascii SIP/2.0\r\nHost: foobar.com\r\n\r\n",
    |req| {
        assert_eq!(req.method.unwrap(), "GET");
...
req! {
    urltest_237,
    b"GET /0?baz=bam&qux=baz SIP/2.0\r\nHost: somehost\r\n\r\n",
    |req| {
        assert_eq!(req.method.unwrap(), "GET");
...
req! {
    urltest_241,
    b"GET /foo.bar.org?type=TXT SIP/2.0\r\nHost: fw.example.org\r\n\r\n",
    |req| {
        assert_eq!(req.method.unwrap(), "GET");
...
req! {
    urltest_242,
    b"GET /ou=People,o=JNDITutorial SIP/2.0\r\nHost: localhost\r\n\r\n",
    |req| {
        assert_eq!(req.method.unwrap(), "GET");
...
req! {
    urltest_245,
    b"GET joe@example.org,2001:foo/bar SIP/2.0\r\nHost: \r\n\r\n",
    |req| {
        assert_eq!(req.method.unwrap(), "GET");
...
req! {
    urltest_247,
    b"GET https://example.com:443/ SIP/2.0\r\nHost: \r\n\r\n",
    |req| {
        assert_eq!(req.method.unwrap(), "GET");
...
req! {
    urltest_248,
    b"GET d3958f5c-0777-0845-9dcf-2cb28783acaf SIP/2.0\r\nHost: \r\n\r\n",
    |req| {
        assert_eq!(req.method.unwrap(), "GET");
...
req! {
    urltest_258,
    b"GET /test-a-colon-slash.html SIP/2.0\r\nHost: \r\n\r\n",
    |req| {
        assert_eq!(req.method.unwrap(), "GET");
...
req! {
    urltest_259,
    b"GET /test-a-colon-slash-slash.html SIP/2.0\r\nHost: \r\n\r\n",
    |req| {
        assert_eq!(req.method.unwrap(), "GET");
...
req! {
    urltest_260,
    b"GET /test-a-colon-slash-b.html SIP/2.0\r\nHost: \r\n\r\n",
    |req| {
        assert_eq!(req.method.unwrap(), "GET");
...
req! {
    urltest_261,
    b"GET /test-a-colon-slash-slash-b.html SIP/2.0\r\nHost: b\r\n\r\n",
    |req| {
        assert_eq!(req.method.unwrap(), "GET");
...
req! {
    urltest_nvidia,
    b"GET /nvidia_web_services/controller.gfeclientcontent.php/com.nvidia.services.GFEClientContent.getShieldReady/{\"gcV\":\"2.2.2.0\",\"dID\":\"1341\",\"osC\":\"6.20\",\"is6\":\"1\",\"lg\":\"1033\",\"GFPV\":\"389.08\",\"isO\":\"1\",\"sM\":\"16777216\"} SIP/2.0\r\nHost: gfwsl.geforce.com\r\n\r\n",
    |req| {
        assert_eq!(req.method.unwrap(), "GET");
